...
class MultiClassTest {
    ...
    static class StaticHelper {
        ...
        static class DeeperNested {
            static void help() {
                println("Controller sourced MultiClassTest\$StaticHelper\$DeeperNested")
            }
        }
    }
    ...
    static void test() {
        ...
        Runnable anonymous2 = new Runnable() {
            void run() {
                println("Controller sourced MultiClassTest\$2 (anonymous)")
            }
        }
        anonymous2.run()
        ...
        Runnable anonymous3 = new Runnable() {
            void run() {
                println("Controller sourced MultiClassTest\$3 (anonymous)")
            }
        }
        anonymous3.run()
        ...
        def closure1 = { 
            println("Controller sourced MultiClassTest closure1")
        }
        closure1()
        
        def closure2 = {
            println("Controller sourced MultiClassTest closure2")
        }
        closure2()
        ...
        println("Controller sourced TestInterface exists: " + (TestInterface != null))
    }
}
...
trait TestTrait {
    void traitMethod() {
        println("Controller sourced TestTrait.traitMethod()")
    }
}
...
enum TestEnum {
    VALUE_A {
        void describe() {
            println("Controller sourced TestEnum.VALUE_A")
        }
    },
    VALUE_B {
        void describe() {
            println("Controller sourced TestEnum.VALUE_B")
        }
    }
